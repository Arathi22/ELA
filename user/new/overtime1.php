                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Status <small>Leave Information </small>
                        </h1>
                    </div>
                </div>
                <!-- /. ROW  -->
                    ...
                    <div class="panel panel-default">
							...
							<div class="panel panel-primary">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<a href="overtime.php"><button class='btn btn-primary btn'>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
								...
								<?php
                                $id=$_SESSION['sid'];
     $stmt = $admin->ret("SELECT * FROM `overtime` inner join `staff` on `staff`.sid=`overtime`.staff_id1 where staff_id1='".$id."'");
