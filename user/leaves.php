...
<div class="inner-block">
    	...
    	<div class="blankpage-main">
          ...
          <div id="collapseTwo" class="panel-collapse in" style="height: auto;">
                                        <div class="panel-body">
                                            <form method='post' action="../controller/leave.php">
    ...
    <input  type="hidden" name='id'  class='form-control'value="<?php echo $_GET['id'];?>" >
                                        ...
                                        <div class='modal-body'>
                                            ...
                                            <input name='reason'  class='form-control' pattern="[A-Za-z\s]+" title="Letters and space only" placeholder='Reason' required="">
                                            </div>
                                        </div>
                                        
                                        <!--  -->
                                        <div class='modal-footer'>
                                            <a href="leaves1.php"><button type='button' class='btn btn-default' data-dismiss='modal'>Close</button></a>
