...
<div class="inner-block">
    <div class="blank">
        ...
        <div class="table-responsive">
                   ...
                   <?php
                                     $id="approved";
     $stmt = $admin->ret("SELECT * FROM `resume` where rstatus='".$id."'");
    ...
    <!-- <?php if($row['re_status']=="selected")
    {?>
    <td><button>approved</button></td>
    <?php }else{?>
        <td> <a href="../controller/updaterestatus.php?id=<?php echo $row['resume_id'];?>"><button class="btn btn-primary">approve</button></a></td>
    <?php }?>
    -->
