...
<div class="inner-block">
    <div class="blank">
    	...
    	<div class="blankpage-main">
            ...
            <div class="panel-body">
                   ...
                   <?php
     $stmt = $admin->ret("SELECT * FROM `resume`");
    ...
    <?php if($row['rstatus']=="approved"){?>
      <td> <button>Approved</button></td>  
  <?php }else{?>
    <td> <a href="../controller/viewresume.php?id=<?php echo $row['resume_id'];?>"><button class="btn btn-primary">Approve</button></a></td>
<?php }?>
