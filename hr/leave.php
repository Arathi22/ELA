...
<div class="inner-block">
    <div class="blank">
    	...
    	<div class="blankpage-main">
                  ...
                  <div class="panel panel-primary">
                   ...
                   <?php
     $stmt = $admin->ret("SELECT * FROM `leave` inner join `staff` on `staff`.sid=`leave`.staff_id");
    ...
    <td><?php echo $row['saddr'];?></td>
     ...
     <?php if($row['lstatus']=="approved"){?>
        <td><button>approved</button></td>
        <?php }else{?>
    
     <td> <a href="../controller/lstatus.php?id=<?php echo $row['leave_id'];?>"><button>approve</button></a></td>
 <?php }?>
