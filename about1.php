...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="ftco-blocks-cover-1">
      <div class="ftco-cover-1 overlay" style="background-image: url('images/air.jpg')">
        <!-- <div class="container">
        ...
        <div class="row">
          <div class="col-12">
            ...
            <!-- <p class="mb-4">You can join with us.</p> -->
             <div class="col-13">
            <p class="mb-9">"Our staffs are the face of ELA.  They work extremely hard every day to offer passengers an unbeatable travel experience – on the ground and in the air. Meet the people who help ELA to reach new heights day after day".</p></div>
             <div class="col-14">
            <p class="mb-10">Start  planning  your perfect trip. For the full lowdown on where we fly, and how to make
everyday amazing when you get there you’ll find all the insider inspiration you need in our 
destination.
</p><br><br><br><br><br>
</div>            <!-- <p>
